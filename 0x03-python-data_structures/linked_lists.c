...
/**
 * print_listint - It prints all elements of  listint_t list
 ...
 * @head: a pointer to the pointer of first node of listint_t list
 ...
 * @head: a pointer to the list  being freed
 * Return: void
 */
